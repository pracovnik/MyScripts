...
pathXXL=[]
pathXXL.append("/xdd/data/Dlhodobe")
pathXXL.append("/ssd/nextcloud/data/ivo/files/Printer")
pathXXL.append("/xdd/data/2023")
pathXXL.append("/xdd/data/2024")


for pathOne in pathXXL:
    for pathS in Path(pathOne).rglob('DSC_*.JPG'):
